...
CREATE OR REPLACE PACKAGE BODY PKG_VALIDACIONES IS
  ...
  * han sido liquidados. El proceso automático de validacion va a retomar estos boletos en su      *
  ...
  *                                                                                            *
  * Boletos con código de autorizacion no existente en la base de gobierno                     *
  *                                                                                            *
...
SELECT  m.ID_TIPO_EMPRESA
  ...
  *                                                                                                     *
  * Boletos con un boleto anterior preexistiente con la misma autorización y fecha exacta de movimiento *
  *                                                                                                     *
  ...
  ******************************************************************************************************/
  ...
  BEGIN
    ...
    -- validar posterior a la extracción del repetido
  ...
  *                                                                                            *
  * Boletos sin código de empresa o con codigo menor a uno                                     *
  *                                                                                            *
  ...
  *                                                                                            *
  * Boletos sin código de autorizacion o con codigo menor a uno                                *
  *                                                                                            *
...
--                        TRANSPORTE.T_TIPOS_EMPRESA E,
  ...
  *                                                          *
  * Boletos con fecha dentro de un período de receso escolar *
  *                                                          *
  * Validacion 6 - RECH206                                   *
  ***********************************************************/
  FUNCTION FU_VALIDAR_RECESO(I_ID_MOVIMIENTO IN T_MOVIMIENTOS.ID_MOVIMIENTO%TYPE)
  ...
  *****************************************************************************************************/
  ...
  BEGIN
    ...
    THEN
      RAISE_APPLICATION_ERROR(-20001
                             ,'Los parámetros de rangos de fecha son ambos obligatorios.');
    END IF;
